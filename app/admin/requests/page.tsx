 ...
 * /admin/requests
 *
 * Shows all requests with filtering and sorting
 */
...
import { Inbox, RefreshCw, Search, ArrowLeft, ChevronUp, ChevronDown } from 'lucide-react';
          ...
          <table className="min-w-full divide-y divide-border">
            <thead className="bg-muted">
              <tr>
                ...
                <SortableHeader column="offersCount" label="Offerter" className="text-right" />
                ...
                filteredRequests.map((request) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="text-sm font-medium text-foreground">{request.offersCount}</div>
                      {request.acceptedOffers > 0 && (
                        <div className="text-xs text-green-600">{request.acceptedOffers} accepterade</div>
                      )}
                    </td>
