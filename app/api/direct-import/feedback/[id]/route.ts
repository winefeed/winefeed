 ...
 *
 * GET /api/direct-import/feedback/[id] - Get single feedback item
 * PATCH /api/direct-import/feedback/[id] - Update feedback (status, title, details)
 */
...
export async function GET(
  ...
  try {
    ...
    console.error('[API] GET /api/direct-import/feedback/[id] error:', error);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    if (error) {
      ...
      console.error('[API] PATCH /api/direct-import/feedback/[id] error:', error);
