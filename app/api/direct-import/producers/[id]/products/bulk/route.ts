 ...
 *
 * PATCH /api/direct-import/producers/[id]/products/bulk - Bulk update products
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[API] PATCH /api/direct-import/producers/[id]/products/bulk error:', error);
