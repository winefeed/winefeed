 ...
 *
 * GET /api/direct-import/producers/[id] - Get producer details
 * PATCH /api/direct-import/producers/[id] - Update producer
 * DELETE /api/direct-import/producers/[id] - Delete producer and all products
 */
...
export async function GET(
  ...
  try {
    ...
    console.error('[API] GET /api/direct-import/producers/[id] error:', error);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[API] PATCH /api/direct-import/producers/[id] error:', error);
    return NextResponse.json(
      { error: 'Internal server error', details: error instanceof Error ? error.message : 'Unknown error' },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[API] DELETE /api/direct-import/producers/[id] error:', error);
    return NextResponse.json(
      { error: 'Internal server error', details: error instanceof Error ? error.message : 'Unknown error' },
      { status: 500 }
    );
