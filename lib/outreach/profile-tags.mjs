...
const TAG_PATTERNS = [
  ...
  { tag: 'organic', pattern: /ekolog|organic|kravm[äa]rkt|biodynamisk|hållbarhet/i },
  { tag: 'glas_rotation', pattern: /glasvin|glas.rotation|coravin|by.the.glass/i },
  { tag: 'star_wine_list', pattern: /star wine list|\bswl\b|white star/i },
  { tag: 'michelin', pattern: /michelin/i },
  { tag: 'falstaff', pattern: /falstaff/i },
  { tag: 'vib', pattern: /\bvib\b|sällsynt|prestige/i },
  { tag: 'many_countries', pattern: /\b(\d{2,})\s*(länder|countries|nations)|olika.l[äa]nder|många.l[äa]nder|brett.curat|internationell/i },
  { tag: 'premium', pattern: /premium|fine.dining|gulddrake|topp.kvalitet|m[äa]starklass/i },
