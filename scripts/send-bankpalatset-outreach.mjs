...
<body style="margin: 0; padding: 0; background-color: #f9fafb;">
  ...
  <p style="margin: 0 0 18px 0;">Hej Simon!</p>

  <p style="margin: 0 0 18px 0;">Vi har sett att du står bakom Bankpalatset på Järnvägsgatan 7. Bistro, vinbaren Weinberry och cocktail-lounge i 600 kvm 1884-arkitektur är en magnifik scen, och Weinberry-namnet får oss att gissa att vinbaren är en hjärtefråga.</p>
  ...
  <p style="margin: 0 0 12px 0;">Ett par exempel som kan passa en bistro/vinbar med klassisk profil:</p>
  <ul style="margin: 0 0 18px 0; padding-left: 20px;">
    <li style="margin-bottom: 8px;"><strong>Château Tour-Calon</strong> (Castillon Côtes de Bordeaux). 32 årgångar i lager, från 1958 till 2018. 2005 ligger på 309 kr ex moms, så ni kan servera 20-årig Bordeaux som glasvin</li>
...
const text = `Hej Simon!

Vi har sett att du står bakom Bankpalatset på Järnvägsgatan 7. Bistro, vinbaren Weinberry och cocktail-lounge i 600 kvm 1884-arkitektur är en magnifik scen, och Weinberry-namnet får oss att gissa att vinbaren är en hjärtefråga.
...
Ett par exempel som kan passa en bistro/vinbar med klassisk profil:
- Château Tour-Calon (Castillon Côtes de Bordeaux). 32 årgångar i lager, från 1958 till 2018. 2005 ligger på 309 kr ex moms, så ni kan servera 20-årig Bordeaux som glasvin
