...
const TO = 'magnus@gardsholwines.com';
const SIGNUP_URL = 'https://winefeed.se/leverantorer?utm_source=outreach&utm_medium=email&utm_campaign=supplier_onboard&utm_content=gardshol';

const WINE = '#722F37';
const ROSE = '#E8B4B8';
const CREME = '#E8DFC4';

const subject = 'Winefeed — skapa ditt konto och ladda upp sortimentet';
  ...
  <div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="background: white; padding: 30px;">
      ...
      <p style="color: #4b5563; line-height: 1.7; margin: 0 0 20px 0; font-size: 15px;">
        Kul att ni vill testa Winefeed! Här kommer länken för att skapa ert leverantörskonto och ladda upp ert sortiment.
      </p>
      ...
      <div style="background: linear-gradient(135deg, rgba(232,180,184,0.15) 0%, rgba(232,223,196,0.15) 100%); border-left: 4px solid ${ROSE}; border-radius: 0 8px 8px 0; padding: 20px 24px; margin: 25px 0;">
        ...
        <ol style="color: #4b5563; margin: 0; padding-left: 18px; line-height: 2.2; font-size: 14px;">
          <li style="padding-left: 8px;">Klicka på knappen nedan och skapa ert konto (tar ca 2 min)</li>
          <li style="padding-left: 8px;">Ladda upp era viner — namn, druva, region, årgång</li>
          <li style="padding-left: 8px;">Restauranger hittar era viner via sökning och matchning</li>
          <li style="padding-left: 8px;">Ni får förfrågningar och svarar med offert direkt i plattformen</li>
        </ol>
      </div>
      ...
      <div style="background: #f0fdf4; border-left: 4px solid #22c55e; border-radius: 0 8px 8px 0; padding: 16px 20px; margin: 25px 0;">
        <p style="color: #166534; margin: 0; font-size: 14px; line-height: 1.6;">
          <strong>Helt gratis under piloten</strong> (t.o.m. 30 juni 2026). Inga avgifter, inga bindningstider. Vi vill bara att det ska fungera bra för er.
        </p>
      </div>

      <!-- CTA Button -->
      <div style="text-align: center; margin: 30px 0;">
        <a href="${SIGNUP_URL}" style="display: inline-block; background: ${WINE}; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px; box-shadow: 0 2px 8px rgba(122,27,45,0.25);">
