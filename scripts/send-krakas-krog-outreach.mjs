/**
 * Skickar outreach-mejl till Krakas Krog (Gotland) / Ulrika Karlsson.
 * Mall: docs/OUTREACH_TEMPLATE_RESTAURANG.md (v1.1)
 *
 * Avsiktlig produktions-outreach godkänd av Markus 2026-05-04.
 *
 * To: info@krakas.se
 * BCC: markus@winefeed.se
 * From: Markus på Winefeed <markus@winefeed.se>
 *
 * Anpassningar: ödmjuk profil-fit-kommentar (Bourgogne-täckning begränsad)
 * + två Pinot Noir-exempel från icke-Bourgogne-regioner.
 */
...
<body style="margin: 0; padding: 0; background-color: #f9fafb;">
  ...
  <p style="margin: 0 0 18px 0;">Hej Ulrika!</p>

  <p style="margin: 0 0 18px 0;">Vi har följt Krakas Krog en tid. 300 referenser i en källare på östra Gotland, med Bourgogne-fokus och 15+ år som sommelier-ägare, är något få i Sverige håller på den nivån. Och inför säsongsstart i juni gissar vi att sourcing från fastlandet just nu är som mest intensivt.</p>

  <p style="margin: 0 0 18px 0;">Vi startar upp Winefeed, en B2B-plattform där restauranger lägger en förfrågan ("Bourgogne under 250 kr, 12 flaskor") och får offert tillbaka från svenska importörer som har matchande viner. Tanken: ni slipper ringa runt eller jaga prislistor, särskilt inte från en ö där importörer ofta deprioriterar leveranser.</p>
  ...
  <p style="margin: 0 0 12px 0;">Ärlig kommentar om profilfit: vår Bourgogne-täckning är begränsad än, där täcker era befintliga importörer förmodligen bättre. Däremot har vi Pinot Noir från andra regioner som kan vara intressanta jämförelse-glas:</p>
  <ul style="margin: 0 0 18px 0; padding-left: 20px;">
    <li style="margin-bottom: 8px;"><strong>Misha's Pinot Noir</strong> (Central Otago, Nya Zeeland). Svalt klimat, eleganta tanniner</li>
    <li style="margin-bottom: 8px;"><strong>Småskaliga Pinot Noir från Hemel-en-Aarde</strong>, Sydafrika. Närmare Bourgogne-stil än vad många tror, sval Atlantbris</li>
  </ul>
  ...
  <p style="margin: 0 0 18px 0;">Vill ni testa innan säsongen drar igång? Vi kan skicka en länk så är ni igång på 10 minuter, eller boka in en kort demo på telefon om det känns bättre.</p>
...
const text = `Hej Ulrika!

Vi har följt Krakas Krog en tid. 300 referenser i en källare på östra Gotland, med Bourgogne-fokus och 15+ år som sommelier-ägare, är något få i Sverige håller på den nivån. Och inför säsongsstart i juni gissar vi att sourcing från fastlandet just nu är som mest intensivt.

Vi startar upp Winefeed, en B2B-plattform där restauranger lägger en förfrågan ("Bourgogne under 250 kr, 12 flaskor") och får offert tillbaka från svenska importörer som har matchande viner. Tanken: ni slipper ringa runt eller jaga prislistor, särskilt inte från en ö där importörer ofta deprioriterar leveranser.

Vi har redan ett antal importörer ombord, och fler och fler ansluter sina vinkataloger kommande veckorna, så urvalet växer snabbt. Förutom det vanliga svenska sortimentet finns även en del europeiska producenter som ni inte enkelt hittar hos vanliga distributörer.

Ärlig kommentar om profilfit: vår Bourgogne-täckning är begränsad än, där täcker era befintliga importörer förmodligen bättre. Däremot har vi Pinot Noir från andra regioner som kan vara intressanta jämförelse-glas:

- Misha's Pinot Noir (Central Otago, Nya Zeeland). Svalt klimat, eleganta tanniner
- Småskaliga Pinot Noir från Hemel-en-Aarde, Sydafrika. Närmare Bourgogne-stil än vad många tror, sval Atlantbris
...
Vill ni testa innan säsongen drar igång? Vi kan skicka en länk så är ni igång på 10 minuter, eller boka in en kort demo på telefon om det känns bättre.
