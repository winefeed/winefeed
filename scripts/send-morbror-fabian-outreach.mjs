/**
 * Skickar outreach-mejl till Morbror Fabian (Östersund).
 * Mall: docs/OUTREACH_TEMPLATE_RESTAURANG.md
 *
 * Använder Resend SDK direkt — bypassar dev-guard eftersom detta är
 * en avsiktlig produktion-outreach godkänd av Markus 2026-05-04.
 *
 * To: info@morbrorfabian.se
...
const TO = 'info@morbrorfabian.se';
const BCC = 'markus@winefeed.se';
const FROM = 'Markus på Winefeed <markus@winefeed.se>';
const REPLY_TO = 'markus@winefeed.se';
const SUBJECT = 'Bygger ni vinlistan från noll på Prästgatan 44?';

// Winefeed brand-header (samma som lib/email-templates.ts winefeedEmailHeader)
...
<body style="margin: 0; padding: 0; background-color: #f9fafb;">
  ...
  <p style="margin: 0 0 18px 0;">Hej Wisam och Martin!</p>

  <p style="margin: 0 0 18px 0;">Vi har sett att ni nyligen tagit över Jazzköket-lokalen och döpt om till Morbror Fabian.</p>
  ...
  <p style="margin: 0 0 12px 0;">Ett par exempel:</p>
  <ul style="margin: 0 0 18px 0; padding-left: 20px;">
    <li style="margin-bottom: 8px;"><strong>Château Tour-Calon</strong> (Castillon Côtes de Bordeaux) — 32 årgångar i lager, från 1958 till 2018. 2005 ligger på 309 kr ex moms → ni kan servera 20-årig Bordeaux som glasvin</li>
...
const text = `Hej Wisam och Martin!

Vi har sett att ni nyligen tagit över Jazzköket-lokalen och döpt om till Morbror Fabian.
...
Ett par exempel:
- Château Tour-Calon (Castillon Côtes de Bordeaux) — 32 årgångar i lager, från 1958 till 2018. 2005 ligger på 309 kr ex moms → ni kan servera 20-årig Bordeaux som glasvin
