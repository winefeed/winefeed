...
<body style="margin: 0; padding: 0; background-color: #f9fafb;">
  ...
  <p style="margin: 0 0 18px 0;">Hej Isabell!</p>

  <p style="margin: 0 0 18px 0;">Vi har sett att du leder vinarbetet på Nabo Matbar tillsammans med Felix, och även är inblandad i L'Enoteque, Regio och Culise. Imponerande räckvidd. Era Winemakers Dinners är en signal om att ni aktivt söker nya producenter.</p>
  ...
  <p style="margin: 0 0 12px 0;">För Winemakers Dinners kan en vertikalprovning vara intressant. Ett par exempel ur direktimport-sortimentet:</p>
  <ul style="margin: 0 0 18px 0; padding-left: 20px;">
    <li style="margin-bottom: 8px;"><strong>Château Tour-Calon</strong> (Castillon Côtes de Bordeaux). 32 årgångar i lager, från 1958 till 2018. Möjligt att bygga en 5-glas vertikal från en och samma producent över 60 år</li>
    <li style="margin-bottom: 8px;"><strong>Château Bonalgue Bel-Air</strong> (Pomerol). Klassisk högerstrand, flera årgångar</li>
    <li style="margin-bottom: 8px;"><strong>Château Lateyron</strong>, small-batch Bordeaux</li>
  </ul>
  ...
  <p style="margin: 0 0 18px 0;">Eftersom du är inblandad i flera koncept (Nabo, L'Enoteque, Regio, Culise) räcker det med en registrering. Ni kan lägga separata förfrågningar per restaurang men hantera allt från samma inbox.</p>
...
const text = `Hej Isabell!

Vi har sett att du leder vinarbetet på Nabo Matbar tillsammans med Felix, och även är inblandad i L'Enoteque, Regio och Culise. Imponerande räckvidd. Era Winemakers Dinners är en signal om att ni aktivt söker nya producenter.
...
För Winemakers Dinners kan en vertikalprovning vara intressant. Ett par exempel ur direktimport-sortimentet:
- Château Tour-Calon (Castillon Côtes de Bordeaux). 32 årgångar i lager, från 1958 till 2018. Möjligt att bygga en 5-glas vertikal från en och samma producent över 60 år
- Château Bonalgue Bel-Air (Pomerol). Klassisk högerstrand, flera årgångar
...
Eftersom du är inblandad i flera koncept (Nabo, L'Enoteque, Regio, Culise) räcker det med en registrering. Ni kan lägga separata förfrågningar per restaurang men hantera allt från samma inbox.
