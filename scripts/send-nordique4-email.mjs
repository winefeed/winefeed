...
<body style="margin: 0; padding: 0; background-color: #f9fafb; font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="background: white; padding: 30px;">
      ...
      <p style="color: #4b5563; line-height: 1.7; margin: 0 0 20px 0; font-size: 15px;">
        Markus h&auml;r &mdash; jag driver bland annat Vinkoll och jobbar med Munsk&auml;nkarna.
      </p>
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://www.winefeed.se/leverantorer?utm_source=outreach&utm_medium=email&utm_campaign=growth_pilot&utm_content=nordique4" style="display: inline-block; background: ${WINE}; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px; box-shadow: 0 2px 8px rgba(122,27,45,0.25);">
...
async function main() {
  console.log('Sending onboarding email to Nordique 4...');
  console.log('To: sandra@n4ab.com');
